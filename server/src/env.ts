...
export const chaincode = process.env.CHAINCODE || 'voting';
...
export const couchDBView = process.env.COUCHDBVIEW || 'ch1_voting';
...
export const jwtSharedKey = process.env.JWT_SHARED_KEY || 'shared-blockchain-api-key';
export const jwtIssuer = process.env.JWT_ISSUER || 'https://auth.dev.egritosgroup.gr';
export const jwtAlgorithm = process.env.JWT_ALGO || 'HS256';